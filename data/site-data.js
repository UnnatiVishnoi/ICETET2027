window.siteData = {
  ...
  committee: [
    { group: "Chief Patron", members: [{ name: "Prof. (Dr.) J.P. Pandey", designation: "Vice Chancellor, AKTU Lucknow", photo: "" }, { name: "Shri Dev Murti", designation: "Chairman, SRMS Trust", photo: "" }] },
    { group: "Patron", members: [{ name: "Shri Aditya Murti", designation: "Secretary, SRMS Trust", photo: "" }, { name: "Er. Subhash Mehra", designation: "Trust Advisor, SRMS Trust", photo: "" }] },
    { group: "Director Conference", members: [{ name: "Prof. (Dr.) Prabhakar Gupta", designation: "Principal, SRMS CET, Bareilly", photo: "" }] },
    { group: "Organizing Chair", members: [{ name: "Prof. (Dr.) Anuj Kumar", designation: "SRMS CET, Bareilly", photo: "" }, { name: "Dr. Shailesh Kumar", designation: "SRMS CET&R, Bareilly", photo: "" }, { name: "Prof. (Dr.) Ritu Singh", designation: "SRMS CET, Bareilly", photo: "" }, { name: "Er. Ravi Rastogi", designation: "Scientist-D, NIELIT", photo: "" }] },
    { group: "Convener", members: [{ name: "Dr. Sovan Mohanty", designation: "SRMS CET, Bareilly", photo: "" }, { name: "Dr. Rajesh Kumar", designation: "SRMS CET, Bareilly", photo: "" }, { name: "Dr. Ravindra Kumar", designation: "SRMS CET, Bareilly", photo: "" }] },
    { group: "Co-Convener", members: [{ name: "Dr. Avtaar Singh", designation: "SRMS CET, Bareilly", photo: "" }, { name: "Ms. Smita Dinkar", designation: "SRMS CET, Bareilly", photo: "" }, { name: "Ms. Parul Dixit", designation: "SRMS CET, Bareilly", photo: "" }] },
    { group: "Organizing Secretary", members: [{ name: "Er. Vivek Yadav", designation: "SRMS CET, Bareilly", photo: "" }, { name: "Mr. Shashank Mishra", designation: "SRMS CET, Bareilly", photo: "" }, { name: "Dr. Satya Dev", designation: "SRMS CET, Bareilly", photo: "" }] },
    { group: "Organizing Committee", members: ["Er. Anuj Agarwal", "Er. Preeti Verma", "Er. Mahendra Singh", "Er. Sumbul", "Er. Dipti Nigam", "Er. Amit Kumar", "Er. Madhur Sharma", "Er. Ashwani Kumar", "Er. Sakshi Tiwari", "Dr. Pradeep Kr. Yadav", "Dr. Pushpendra Yadav"].map((name) => ({ name, designation: "SRMS CET, Bareilly", photo: "" })) },
